...
N 140 -170 470 -170 {lab=VOUT}
N 140 -240 140 -170 {lab=VOUT}
...
.control
tran 1n 15u
meas tran t_10 when v(vout)=0.78 rise=1
meas tran t_90 when v(vout)=1.58 rise=1

let SR_avg=0.8/(t_90-t_10)/1000000
print SR_avg
